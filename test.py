...
def angle(ang1,ang2):
    ...
    if(angleg >0 and angler>0):
        c=angler - angleg
    elif(angleg<0 and angler<0):
        if(angleg<angler):
            c = 0-(angleg-angler)
        else:
            c=0-(angler-angleg)
...
def main():
    ...
    #print(g1,g2)
    fianl_angle_red=angle(ang,red_angle)
    print(fianl_angle_red)
    """final_angle_green1=angle(ang,g1)
    final_angle_green2=angle(ang,g2)
    g1_node=round((final_angle_green1)/32) 
    g2_node=round((final_angle_green2)/32) 
    print("g1",g1)
    print("g2",g2)
    print("green1 node",g1_node)
    print("green2 node ",g2_node)"""

    red_node=round(fianl_angle_red / 32) 
